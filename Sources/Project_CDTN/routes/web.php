...
Route::group(['prefix' => 'index'], function () {
    ...
    Route::group(['prefix' => 'Teacher', 'middleware' => ['only.teacher']], function () {
        ...
        Route::get('form-Look-up-learning-results', 'Index\TeacherIndexController@learningSearch')->name('learning.search');

        Route::post('search-results', 'Index\TeacherIndexController@postLearning')->name('teacher.postSearch');
